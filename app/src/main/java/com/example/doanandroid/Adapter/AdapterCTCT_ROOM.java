...
public class AdapterCTCT_ROOM extends RecyclerView.Adapter<AdapterCTCT_ROOM.ViewHodel> {
    Context context;
    List<CLA_Model> mechanicalList;

    public AdapterCTCT_ROOM(Context context, List<CLA_Model> mechanicalList) {
    ...
    public void onBindViewHolder(@NonNull ViewHodel holder, @SuppressLint("RecyclerView") int i) {
        ...
        holder.txt_size.setText(mechanicalList.get(i).getLink().getSize());
