...
public class AdapterNew_Trainning extends RecyclerView.Adapter<AdapterNew_Trainning.ViewHodel> {
    ...
    public AdapterNew_Trainning(Context context, List<Mechanical> mechanicalList, List<ContentLink> contentLinks) {
    ...
    public void onBindViewHolder(@NonNull ViewHodel holder, int i) {
        ...
        for (int j = 0; j < contentLinks.size(); j++){
            Log.d("abc", contentLinks.get(j).getId());
        }
