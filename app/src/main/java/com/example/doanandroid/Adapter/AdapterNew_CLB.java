...
public class AdapterNew_CLB extends RecyclerView.Adapter<AdapterNew_CLB.ViewHodel> {
    Context context;
    List<Infor_All_CNTT> recruit_cnttList;

    public AdapterNew_CLB(Context context, List<Infor_All_CNTT> recruit_cnttList) {
