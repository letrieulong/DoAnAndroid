...
public class AdapterSearch_CTCT_HSSV extends RecyclerView.Adapter<AdapterSearch_CTCT_HSSV.ViewHodel> {
    Context context;
    List<New_Tranning> mechanicalList;

    public AdapterSearch_CTCT_HSSV(Context context, List<New_Tranning> mechanicalList) {
