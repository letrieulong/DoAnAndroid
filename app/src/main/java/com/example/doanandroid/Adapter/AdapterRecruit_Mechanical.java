...
public class AdapterRecruit_Mechanical extends RecyclerView.Adapter<AdapterRecruit_Mechanical.ViewHodel> {
    Context context;
    List<Mechanical> mechanicalList;

    public AdapterRecruit_Mechanical(Context context, List<Mechanical> mechanicalList) {
