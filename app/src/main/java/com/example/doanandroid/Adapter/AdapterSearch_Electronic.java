...
public class AdapterSearch_Electronic extends RecyclerView.Adapter<AdapterSearch_Electronic.ViewHodel> {
    Context context;
    List<News_Electronic> mechanicalList;

    public AdapterSearch_Electronic(Context context, List<News_Electronic> mechanicalList) {
    ...
    public void filterList(ArrayList<News_Electronic> filterllist) {
